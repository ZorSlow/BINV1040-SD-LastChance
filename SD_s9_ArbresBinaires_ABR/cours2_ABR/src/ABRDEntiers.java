...
public class ABRDEntiers {
    ...
    public int min() throws ArbreVideException {
        ...
        return min(racine);
        /*
		if (racine == null)throw new ArbreVideException("arbre est vide");
		return min(racine);
         */

    }
	private int min(NoeudEntier noeud){       // façon iterative
		NoeudEntier courant = racine;
		if (noeud == null)throw new ArbreVideException("arbre est vide");
		while (courant.gauche != null){
			courant = courant.gauche;
		}
		return courant.entier;
	}
/*
